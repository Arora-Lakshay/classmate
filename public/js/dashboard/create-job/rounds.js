...
(() => {
/*!***********************************************!*\
  !*** ./src/js/dashboard/create-job/rounds.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _notify__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../notify */ "./src/js/notify.js");

var roundsForm = document.querySelector(".create-job main .form-area .form-container form#rounds-form");
var addRoundBtn = document.querySelector(".create-job main .form-area .form-container .add-rounds button#add-new-round");
...
addRoundBtn.addEventListener("click", function (e) {
  ...
  rounds[total] = {};
  roundsCon.forEach(function (rd) {
    var inputs = rd.querySelectorAll("fieldset .avalid.input");
  ...
  roundsCon.forEach(function (round, idx) {
    var inputs = round.querySelectorAll("fieldset .avalid.input");
    inputs.forEach(function (inp) {
      var feild = inp.querySelector('input');
      feild.addEventListener("input", function (e) {
        if (isValid(e.target)) {
...
roundsForm.addEventListener("submit", function (e) {
  e.preventDefault();
...
function validateForm(roundsCon) {
  ...
  if (roundsCon.length) {
    roundsCon.forEach(function (rd) {
      var inputs = rd.querySelectorAll("feildset .avalid.input");
      inputs.forEach(function (input) {
        var feild = input.querySelector('input');
    ...
    var notification = notifier.notify("error", "Required to include atleast one round");
    notification.push();
    return false;
  }
