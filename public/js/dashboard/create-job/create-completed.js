...
"use strict";
/*!*********************************************************!*\
  !*** ./src/js/dashboard/create-job/create-completed.js ***!
  \*********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _notify__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../notify */ "./src/js/notify.js");
...
var preloader = document.querySelector(".create-job main .form-area .job-completed .job-preloader-container");
var success = document.querySelector(".create-job main .form-area .job-completed .job-completed-success");
var notifier = new _notify__WEBPACK_IMPORTED_MODULE_1__["default"]();

function saveJob(_x) {
  return _saveJob.apply(this, arguments);
}

function _saveJob() {
  _saveJob = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(url) {
    var response;
...
saveJob('/api/in/save-job').then(function (res) {
  if (res.success) {
    setTimeout(function () {
      preloader.style.display = "none";
      success.style.display = "flex";
    }, 5000);
    var successBtn = success.querySelector(".success-button button#success-redirect-button");
