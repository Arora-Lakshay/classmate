...
(() => {
/*!***********************************************************!*\
  !*** ./src/js/dashboard/create-job/additional-details.js ***!
  \***********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _notify__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../notify */ "./src/js/notify.js");

var inputs = document.querySelectorAll(".create-job main .form-area .form-container form .imp-contact .half-container fieldset .avalid.input");
var addDetailsForm = document.querySelector(".create-job main .form-area .form-container form#additional-details-form");
...
function sendForm() {
  var FD = new FormData(addDetailsForm);
...
function validateForm() {
  var isVal = true;
  var allFilled = true;
  var name = document.querySelector(".create-job main .form-area .form-container form .imp-contact .half-container fieldset .avalid.input input#additional-imp-contact-name");
  var contact = document.querySelector(".create-job main .form-area .form-container form .imp-contact .half-container fieldset .avalid.input input#additional-imp-contact-phone");
  ...
  if (name.value && contact.value) {
    ...
    var notification = notifier.notify("error", "Complete all related feilds");
    notification.push();
    return false;
  }
