...
(() => {
/*!********************************************************!*\
  !*** ./src/js/dashboard/create-job/job-description.js ***!
  \********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _notify__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../notify */ "./src/js/notify.js");

var input = document.querySelector(".create-job main .form-area .form-container form fieldset .avalid.input");
var descriptionForm = document.querySelector(".create-job main .form-area .form-container form#job-description-form");
...
var timer;
var timeoutVal = 2000;
var feild = input.querySelector('textarea'); // triggers a check to see if the user is actually done typing
...
function sendForm() {
  var FD = new FormData(descriptionForm);
...
function validateForm() {
  var isVal = true;
  var allFilled = true;
  var feild = input.querySelector('textarea');
