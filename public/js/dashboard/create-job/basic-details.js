...
(() => {
/*!******************************************************!*\
  !*** ./src/js/dashboard/create-job/basic-details.js ***!
  \******************************************************/
__webpack_require__.r(__webpack_exports__);
...
var detailsForm = document.querySelector(".create-job main .form-area .form-container form#basic-details-form");
    ...
    ch.addEventListener("change", function (e) {
      ...
      if (e.target.checked) {
        ...
        if (input.id === "job-domains" && jobDomains.includes(e.target.value)) {
          var i = jobDomains.indexOf(e.target.value);
          jobDomains.splice(i, 1);
        } else if (input.id === "job-categories" && jobCategories.includes(e.target.value)) {
          var _i = jobCategories.indexOf(e.target.value);

          jobCategories.splice(_i, 1);
        }
      }
    });
  });
...
function isValid(inp) {
  ...
  if (inp.id === "opportunity-end-time" && inp.type === "datetime-local") {
    var start = document.querySelector(".create-job main .form-area .form-container form fieldset .avalid.input input#opportunity-start-time");
