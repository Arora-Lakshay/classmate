...
"use strict";
/*!*****************************************!*\
  !*** ./src/js/dashboard/registerJob.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
...
var applyNowBtn = document.querySelector('main.viewjob-wrapper .upper-banner .details-container .job-highlight a#apply-now-btn');
var markRegisterForm = document.querySelector('main.viewjob-wrapper .upper-banner .details-container form.mark-complete');
var markRegister = document.querySelector('main.viewjob-wrapper .upper-banner .details-container form.mark-complete button#mark-as-registered');
...
markRegisterForm.addEventListener("submit", function (e) {
  e.preventDefault();
  e.target.action = "/api/in/".concat(sid, "/register");
  e.target.method = 'GET';
  e.target.submit();
