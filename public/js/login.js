...
var loginForm = document.querySelector('.form.login #auth-login-form');
var inputs = loginForm.querySelectorAll('fieldset .avalid.input');
var toggler = loginForm.querySelector('fieldset .input.avalid button.toggle');
var submitButton = loginForm.querySelector('button#login-submit');
...
toggler.addEventListener('click', function (e) {
  var password = loginForm.querySelector('fieldset .avalid.input input#password');
